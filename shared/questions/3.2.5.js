var QUIZ_DATA = {
  "meta": {
    ...
    "testTopics": [
      ...
      "Korte termijn: winstmaximalisatie en winst",
      "Lange termijn: toetredingscorrectie naar nulwinst",
      "Berekeningen en grafische analyse"
    ]
  },
  "categories": {
    "monopolistische_concurrentie": {
      "name": "MC Karakteristieken",
      "colors": {
        "bg": "#FEF5E7",
        "text": "#BA6A1C",
        "bar": "#E67E22"
  ...
  "questions": [
    ...
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 1,
      "q": "Welke marktvoorbeelden zijn monopolistische concurrentie?",
      "options": [
    ...
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 2,
      "q": "Hoe kan een bedrijf in monopolistische concurrentie marktmacht uitoefenen?",
      "options": [
        "Door productdifferentiatie en merkopbouw waardoor klanten niet zomaar overstappen",
        "Door de productiekosten zodanig te verlagen dat concurrenten worden verdreven",
        "Door formele samenwerking met andere bedrijven in een kartelovereenkomst",
        "Door prijsafspraken te maken met concurrenten via stilzwijgende collusie"
      ],
      "answer": 0,
      "rationale": "In monopolistische concurrentie ontleent elk bedrijf marktmacht aan productdifferentiatie: hun product is niet volledig vervangbaar door concurrenten."
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 2,
    ...
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 3,
      "q": "Waarom verdwijnt winst op lange termijn in monopolistische concurrentie (nulwinst-evenwicht)?",
      "options": [
        "Omdat de productiekosten per eenheid geleidelijk stijgen door inflatie en grondstofschaarste",
        "Omdat nieuwe bedrijven toetreden en marktaandeel stelen, totdat prijs gelijk is aan gemiddelde totale kosten",
        "Omdat consumenten na verloop van tijd steeds minder gaan kopen van het product",
        "Omdat de overheid belastingen verhoogt waardoor winstmarges verdwijnen"
      ],
      "answer": 1,
      "rationale": "Als bedrijven winst verdienen, treden nieuwe concurrenten toe. Dit verschuift de residuele vraaglijn van bestaande bedrijven naar beneden totdat P = GTK (nulwinst). Vrije toetreding is de sleutel."
    },
    {
      ...
      "options": [
        "Het onderscheid dat bedrijven aan hun product geven via merkvoering, design, kwaliteit en service",
        "Het verschil in verkoopprijs tussen concurrerende bedrijven op dezelfde markt",
        "Het verschil in geproduceerde hoeveelheid tussen grote en kleine bedrijven",
        "Het verschil in toetredingsdrempel tussen verschillende marktvormen"
      ],
      "answer": 0,
      "rationale": "Productdifferentiatie is het onderscheid dat bedrijven creëren via merknaam, ontwerp, locatie, kwaliteit en service."
    },
    {
      "category": "productdifferentiatie",
      "difficulty": 2,
      "q": "Waarom investeren bedrijven in productdifferentiatie?",
      "options": [
        "Omdat het gratis is",
        "Omdat het hun marktmacht versterkt en prijszetting mogelijk maakt zonder klanten te verliezen",
    ...
    },
    {
      "category": "productdifferentiatie",
      "difficulty": 2,
      "q": "Welke vormen van differentiatie bestaan er?",
      "options": [
        "Merkvoering, design, kwaliteit, locatie, service en reputatie",
        "Uitsluitend prijsdifferentiatie door kortingen en aanbiedingen",
        "Alleen productievolume en schaalvoordelen ten opzichte van concurrenten",
        "Alleen marketingbudget en hoeveelheid reclame-uitingen per jaar"
      ],
      "answer": 0,
      "rationale": "Productdifferentiatie omvat alle aspecten waarmee bedrijven hun aanbod onderscheiden: merknaam, ontwerp, kwaliteit, locatie, service, reputatie."
    },
    {
      "category": "productdifferentiatie",
      "difficulty": 3,
      "q": "Hoe beïnvloedt productdifferentiatie de prijselasticiteit van vraag naar een bedrijf?",
      "options": [
        "Maakt de vraag meer elastisch: klanten stappen sneller over naar concurrenten",
        "Maakt de vraag minder elastisch: klanten zijn loyaler en minder prijsgevoelig",
        "Heeft geen meetbaar effect op de prijselasticiteit van de vraag",
        "Maakt de vraag perfect inelastisch: klanten kopen altijd dezelfde hoeveelheid"
      ],
      "answer": 1,
      "rationale": "Differentiatie creëert substitutieresistentie: klanten kunnen niet zomaar overstappen, dus vraag naar het specifieke product is minder prijselastisch."
    },
    {
      "category": "korte_termijn",
      "difficulty": 1,
      "q": "In de korte termijn in monopolistische concurrentie: hoe maximaliseert een bedrijf winst?",
      "options": [
        "Door te produceren waar MO = MK en de prijs af te lezen van de vraaglijn",
        "Door altijd te produceren waar prijs gelijk is aan marginale kosten (P = MK)",
        "Door de hoeveelheid zo hoog mogelijk op te voeren ongeacht de kosten",
        "Door de prijs zo hoog mogelijk te stellen zonder naar de kosten te kijken"
      ],
      "answer": 0,
      "rationale": "Ook in monopolistische concurrentie maximaliseert elk bedrijf winst waar MO = MK (zoals in elk marktmodel). Daarna bepaalt de residuele vraaglijn de prijs."
    },
    {
      "category": "korte_termijn",
      "difficulty": 1,
      "q": "Kan een bedrijf in monopolistische concurrentie winst maken in korte termijn?",
      "options": [
        "Ja, zolang de prijs hoger is dan de gemiddelde totale kosten (P > GTK)",
        "Nee, in monopolistische concurrentie is er altijd nulwinst, ook op korte termijn",
        "Nee, bedrijven in monopolistische concurrentie maken altijd verlies op korte termijn",
        "Alleen als het bedrijf zich gedraagt als een monopolist met volledige marktmacht"
      ],
      "answer": 0,
      "rationale": "In korte termijn kan P > GTK, dus bedrijven kunnen positieve winst realiseren. Op lange termijn zakt dit naar nulwinst door toetreding van nieuwe bedrijven."
    },
    {
      "category": "korte_termijn",
      "difficulty": 2,
      "q": "Stel bedrijf: P = 50 - 0,5Q, MK = 20, GTK = 30 + 10/Q. MO = 50 - Q. Optimale Q?",
      "options": [
        "Q = 30 (MO = MK: 50 - Q = 20 geeft Q = 30)",
        "Q = 15 (halveer de monopoliehoeveelheid)",
        "Q = 20 (stel MO = 0 en los op naar Q)",
        "Q = 25 (gemiddelde van vraag-intercept en MK)"
      ],
      "answer": 0,
      "rationale": "MO = MK: 50 - Q = 20 → Q = 30. P = 50 - 0,5(30) = 35. GTK = 30 + 10/30 ≈ 30,33. Winst = (35 - 30,33) × 30 ≈ 140."
    },
    {
      "category": "korte_termijn",
      "difficulty": 2,
      "q": "Hoe ziet de vraaglijn eruit die een bedrijf in monopolistische concurrentie ziet?",
      "options": [
    ...
    },
    {
      "category": "rekenen",
      "difficulty": 2,
      "q": "Drie identieke bedrijven in lange termijn evenwicht. Totale marktQ = 60. Elk bedrijf Q = ?",
      "options": [
        "Q = 20",
        "Q = 15",
        "Q = 30",
      ...
      "answer": 0,
      "rationale": "Met identieke bedrijven en evenwicht: verdeling is gelijk. Q per bedrijf = 60 / 3 = 20."
    },
    {
      "category": "rekenen",
      "difficulty": 3,
    ...
    },
    {
      ...
      "difficulty": 1,
      "q": "Vergelijk monopolistische concurrentie en volkomen concurrentie: welke marktvoorwaarde verschilt het meest?",
      "options": [
        "Productdifferentiatie: bij VC is het product homogeen, bij MC heterogeen",
        "Het aantal bedrijven: bij VC zijn er veel meer bedrijven dan bij MC",
        "De toetredingsdrempels: bij VC zijn die veel lager dan bij MC",
        "De rol van de overheid: bij VC is er meer regulering dan bij MC"
      ],
      "answer": 0,
      "rationale": "Volkomen concurrentie: homogeen product, geen marktmacht. Monopolistische concurrentie: heterogeen product, wel marktmacht via productdifferentiatie. Beide hebben veel bedrijven en lage barrières."
    },
    {
      "category": "vergelijking_marktvormen",
      "difficulty": 2,
    ...
    },
    {
      "category": "vergelijking_marktvormen",
      "difficulty": 3,
      "q": "Lange termijn efficiëntie: rangschik volkomen concurrentie, MC, monopolie",
      "options": [
        "VC meest efficiënt, MC neutraal, monopolie minst efficiënt",
        "VC meest efficiënt, MC minder efficiënt dan VC maar beter dan monopolie, monopolie minst efficiënt",
        "MC meest efficiënt",
    ...
    },
    {
      "category": "korte_termijn",
      "difficulty": 1,
      "q": "Bedrijf P = 70 - 0,5Q, TK = 100 + 10Q + 2Q². GTK = 100/Q + 10 + 2Q. Minimale GTK?",
      "options": [
        "GTK minimaal bij Q ≈ 7 (dGTK/dQ = -100/Q² + 2 = 0 geeft Q ≈ 7,07)",
        "GTK minimaal bij Q = 5 (waar vaste kosten per eenheid gelijk zijn aan 20)",
        "GTK minimaal bij Q = 10 (waar marginale kosten gelijk zijn aan gemiddelde kosten)",
        "GTK minimaal bij Q = 15 (waar de totale kosten het laagst zijn per eenheid)"
      ],
      "answer": 0,
      "rationale": "dGTK/dQ = -100/Q² + 2 = 0 → 2Q² = 100 → Q² = 50 → Q ≈ 7,07. Dichtstbij Q = 7."
    },
    {
      "category": "korte_termijn",
      "difficulty": 3,
      "q": "Waarom opereren bedrijven in MC niet op minimale GTK?",
      "options": [
        "Omdat toetredingscorrectie de vraaglijn verschuift zodat P = GTK bereikt wordt links van het GTK-minimum",
        "Omdat de marginale kosten negatief worden bij hogere productieniveaus",
        "Omdat bedrijven in MC altijd te groot zijn voor hun marktaandeel",
    ...
    },
    {
      "category": "lange_termijn",
      "difficulty": 1,
      "q": "Lange termijn evenwicht monopolistische concurrentie: bedrijf P = ?",
      "options": [
        "P = GTK (nulwinst door vrije toetreding, maar niet noodzakelijk op minimum GTK)",
        "P = MK (allocatief efficiënt, zoals bij volkomen concurrentie)",
        "P = gemiddelde variabele kosten (sluitingspunt van het bedrijf)",
    ...
    },
    {
      "category": "productdifferentiatie",
      "difficulty": 1,
      "q": "Welk product is het MINST gedifferentieerd en past daarom het minst bij monopolistische concurrentie?",
      "options": [
        "Ongemerkt wit brood uit de supermarkt (nauwelijks productdifferentiatie)",
        "Nike-sportschoenen met herkenbaar merk, design en marketingcampagnes",
        "Starbucks-koffie met unieke locatie, ambiance en merkbeleving",
        "Coca-Cola met sterke merknaam, geheim recept en wereldwijde reclame"
      ],
      "answer": 0,
      "rationale": "Ongemerkt brood is relatief homogeen met minimale differentiatie. Nike, Starbucks en Coca-Cola differentiëren sterk op merk, design en beleving."
    },
    {
      "category": "productdifferentiatie",
      "difficulty": 2,
    ...
    },
    {
      ...
      "answer": 0,
      "rationale": "Gelijke bedrijven: verdeling gelijk. 200 / 2 = 100 per bedrijf."
    },
    {
      "category": "rekenen",
      "difficulty": 2,
    ...
    },
    {
      "category": "vergelijking_marktvormen",
      "difficulty": 1,
      "q": "In welke marktvorm is er MEER ruimte voor eigen prijsbepaling: monopolistische concurrentie of volkomen concurrentie?",
      "options": [
        "Monopolistische concurrentie, want elk bedrijf kan zijn eigen prijs zetten via differentiatie",
        "Volkomen concurrentie, want door veel aanbieders ontstaat er meer prijsdruk op de markt",
        "In beide marktvormen hebben bedrijven precies evenveel invloed op de prijs",
        "Dit hangt volledig af van de seizoensgebonden vraag naar het product"
      ],
      "answer": 0,
      "rationale": "Monopolistische concurrentie: elk bedrijf is prijszetter (via differentiatie). Volkomen concurrentie: bedrijven zijn prijsnemers (geen marktmacht, prijs is gegeven)."
    },
    {
      "category": "vergelijking_marktvormen",
      "difficulty": 2,
    ...
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 1,
      "q": "Hoe verschilt de vraaglijn van een bedrijf in MC van die in volkomen concurrentie?",
      "options": [
        "MC: naar beneden hellende vraaglijn (prijszetter), VC: horizontale vraaglijn (prijsnemer)",
        "MC: horizontale vraaglijn (prijsnemer), VC: naar beneden hellende vraaglijn (prijszetter)",
        "MC: verticale vraaglijn (perfect inelastisch), VC: horizontale vraaglijn (perfect elastisch)",
        "MC: stijgende vraaglijn (Giffen-goed), VC: dalende vraaglijn (normaal goed)"
      ],
      "answer": 0,
      "rationale": "Volkomen concurrentie: bedrijf is prijsnemer, horizontale vraaglijn. MC: bedrijf is prijszetter via differentiatie, naar beneden hellende residuele vraaglijn."
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 2,
    ...
    },
    {
      "category": "rekenen",
      "difficulty": 1,
      "q": "MC scenario: 100 bedrijven, markt totaal Q = 1000. Elk bedrijf gemiddeld Q = ?",
      "options": [
        "Q = 10 per bedrijf",
        "Q = 1 per bedrijf",
        "Q = 100 per bedrijf",
      ...
      "answer": 0,
      "rationale": "Gelijke verdeling: 1000 / 100 = 10 per bedrijf."
    },
    {
      "category": "monopolistische_concurrentie",
      "difficulty": 2,
